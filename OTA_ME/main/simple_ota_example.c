...
#define host        "http://api.innoway.vn"
...
char ota_res_topic[] = "messages/fc067ed6-3239-4301-b280-2941feb48549/fota";
char ota_topic[] = "messages/fc067ed6-3239-4301-b280-2941feb48549/ota";
...
{   
    ...
    switch (event->event_id) {
        case MQTT_EVENT_CONNECTED:
            ...
            esp_mqtt_client_subscribe(client, "messages/fc067ed6-3239-4301-b280-2941feb48549/ota", 0);
...
void app_main(void)
{
    ...
    .uri = mqtt_broker,
    .username = "abc2",
    .password = "1Z73oLCBcGwwfJJzOnMZ8bT1QfDxVxOP",
